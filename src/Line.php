 ...
 *
 * Provides a concrete `<line>` element implementation that returns `SvgVoid::LINE` and provides geometry, paint, and
...
final class Line extends BaseVoid
{
     ...
     *
     * @return BackedEnum Tag enumeration instance for `<line>`.
     *
