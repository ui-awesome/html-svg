 ...
 * height attributes.
 *
 * Intended for use in tags and components that require dynamic or programmatic manipulation of the mask coordinate
 ...
 *
 * @link https://developer.mozilla.org/en-US/docs/Web/SVG/Reference/Attribute/maskUnits
 *
...
trait HasMaskUnits
{
     ...
     *
     * @param CoordinateUnits|string|null $value Mask units value to set for the element. Accepts 'userSpaceOnUse',
     ...
     * Usage example:
     * ```php
     * // sets the `maskUnits` attribute to 'objectBoundingBox'
     * $element->maskUnits('objectBoundingBox');
     *
     * // sets the `maskUnits` attribute using an enum
     * $element->maskUnits(CoordinateUnits::USER_SPACE_ON_USE);
     *
     * // unsets the `maskUnits` attribute
