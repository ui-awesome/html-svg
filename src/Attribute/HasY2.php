 ...
 *
 * Intended for use in tags and components that require dynamic or programmatic manipulation of the second y-coordinate
...
trait HasY2
{
     ...
     *
     * @param float|int|string|null $value Second y coordinate value to set for the element. Accepts any valid SVG
     ...
     * Usage example:
     * ```php
     * // sets the `y2` attribute to 10 user units
     * $element->y2(10);
     *
     * // sets the `y2` attribute to 10.3 user units
     * $element->y2(10.3);
     *
     * // sets the `y2` attribute to a relative value
     * $element->y2('50%');
     *
     * // unsets the `y2` attribute
     * $element->y2(null);
     * ```
     */
