 ...
 *
 * Note: The `orient` attribute also accepts numeric angle values (for example, '45', '90deg'). This enum only covers
 * the keyword values. Use string or numeric types for angle values.
 *
 * Key features.
