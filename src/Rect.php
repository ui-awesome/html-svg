 ...
 *
 * Provides a standards-compliant, immutable API for rendering the `<rect>` container element, following the SVG 2 and
 * HTML specifications for defining rectangular shapes.
 *
