 ...
 *
 * Provides a concrete `<rect>` element implementation that returns {@see SvgVoid::RECT} and provides geometry, paint,
...
final class Rect extends BaseVoid
{
     ...
     *
     * @return BackedEnum Tag enumeration instance for `<rect>`.
     *
