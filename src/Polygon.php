 ...
 *
 * Provides a concrete `<polygon>` element implementation that returns {@see SvgVoid::POLYGON} and provides geometry,
...
final class Polygon extends BaseVoid
{
     ...
     *
     * @return BackedEnum Tag enumeration instance for `<polygon>`.
     *
