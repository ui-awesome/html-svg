 ...
 *
 * Provides a concrete `<polyline>` element implementation that returns {@see SvgVoid::POLYLINE} and provides geometry,
...
final class Polyline extends BaseVoid
{
     ...
     *
     * @return BackedEnum Tag enumeration instance for `<polyline>`.
     *
