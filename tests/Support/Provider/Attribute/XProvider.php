 ...
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `x` attribute, supporting
...
final class XProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `x` attribute.
     *
