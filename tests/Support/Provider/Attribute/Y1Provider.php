 ...
 * - Validation of appropriate types and `null` for the `y1` attribute.
 *
...
final class Y1Provider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `y1` attribute.
     *
