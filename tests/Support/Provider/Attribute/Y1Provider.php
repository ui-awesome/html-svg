...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasY1Test} class.
 *
 * Supplies comprehensive test data for validating the handling of the SVG `y1` attribute in tag rendering, ensuring
 * standards-compliant assignment, override behavior, and value propagation according to the SVG 2 specification.
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `y1` attribute, supporting
 ...
 *
 * Key features.
 * - Ensures correct propagation, override, and removal of the `y1` attribute in SVG element rendering.
 * - Named test data sets for precise failure identification.
 * - Validation of float, int, string, and `null` for the `y1` attribute.
 *
...
{
    /**
     * Provides test cases for SVG `y1` attribute rendering scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `y1` attribute, including float,
     * int, string, and `null`.
     *
     * Each test case includes the input value, the initial attributes, the expected rendered output, and an assertion
     * message for clear identification.
     *
     * @return array Test data for `y1` attribute rendering scenarios.
     *
    ...
    /**
     * Provides test cases for SVG `y1` attribute scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `y1` attribute, including float,
     * int, string, and `null`.
     *
     ...
     *
     * @return array Test data for `y1` attribute scenarios.
     *
