 ...
 * - Validation of appropriate types and `null` for the `rx` attribute.
 *
...
final class RxProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `rx` attribute.
     *
