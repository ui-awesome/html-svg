...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasDyTest} class.
 *
 * Supplies comprehensive test data for validating the handling of the SVG `dy` attribute in tag rendering, ensuring
 * standards-compliant assignment, override behavior, and value propagation according to the SVG 2 specification.
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `dy` attribute, supporting
 ...
 *
 * Key features.
 * - Ensures correct propagation, override, and removal of the `dy` attribute in SVG element rendering.
 * - Named test data sets for precise failure identification.
 * - Validation of appropriate types and `null` for the `dy` attribute.
 *
...
{
    /**
     * Provides test cases for SVG `dy` attribute scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `dy` attribute.
     *
     ...
     *
     * @return array Test data for `dy` attribute scenarios.
     *
