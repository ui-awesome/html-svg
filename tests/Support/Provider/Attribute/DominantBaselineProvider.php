 ...
 *
 * Provides representative input/output pairs for testing the `dominant-baseline` attribute functionality.
 *
...
final class DominantBaselineProvider
{
    ...
    {
        $enumCases = EnumDataProvider::attributeCases(DominantBaseline::class, SvgAttribute::DOMINANT_BASELINE);
