 ...
 *
 * Provides representative input/output pairs for testing the `lengthAdjust` attribute functionality.
 *
...
final class LengthAdjustProvider
{
    ...
    {
        $enumCases = EnumDataProvider::attributeCases(LengthAdjust::class, SvgAttribute::LENGTH_ADJUST);
