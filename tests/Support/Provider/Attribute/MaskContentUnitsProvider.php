 ...
 *
 * Provides representative input/output pairs for testing the `maskContentUnits` attribute functionality.
 *
...
final class MaskContentUnitsProvider
{
    ...
    {
        $enumCases = EnumDataProvider::attributeCases(CoordinateUnits::class, 'maskContentUnits');
