 ...
 * - Validation of appropriate types and `null` for the `x2` attribute.
 *
...
final class X2Provider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `x2` attribute.
     *
