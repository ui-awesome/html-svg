...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasX2Test} class.
 *
 * Supplies comprehensive test data for validating the handling of the SVG `x2` attribute in tag rendering, ensuring
 * standards-compliant assignment, override behavior, and value propagation according to the SVG 2 specification.
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `x2` attribute, supporting
 ...
 *
 * Key features.
 * - Ensures correct propagation, override, and removal of the `x2` attribute in SVG element rendering.
 * - Named test data sets for precise failure identification.
 * - Validation of float, int, string, and `null` for the `x2` attribute.
 *
...
{
    /**
     * Provides test cases for SVG `x2` attribute rendering scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `x2` attribute, including float,
     * int, string, and `null`.
     *
     * Each test case includes the input value, the initial attributes, the expected rendered output, and an assertion
     * message for clear identification.
     *
     * @return array Test data for `x2` attribute rendering scenarios.
     *
    ...
    /**
     * Provides test cases for SVG `x2` attribute scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `x2` attribute, including float,
     * int, string, and `null`.
     *
     ...
     *
     * @return array Test data for `x2` attribute scenarios.
     *
