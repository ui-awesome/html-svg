...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasDxTest} class.
 *
 * Supplies comprehensive test data for validating the handling of the SVG `dx` attribute in tag rendering, ensuring
 * standards-compliant assignment, override behavior, and value propagation according to the SVG 2 specification.
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `dx` attribute, supporting
 ...
 *
 * Key features.
 * - Ensures correct propagation, override, and removal of the `dx` attribute in SVG element rendering.
...
{
    /**
     * Provides test cases for SVG `dx` attribute scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `dx` attribute.
     *
     ...
     *
     * @return array Test data for `dx` attribute scenarios.
     *
