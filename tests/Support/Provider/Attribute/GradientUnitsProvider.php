...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasGradientUnitsTest} class.
 *
 * Supplies comprehensive test data for validating the handling of the SVG `gradientUnits` attribute in tag rendering,
 * ensuring standards-compliant assignment, override behavior, and value propagation according to the SVG 2
 * specification.
 *
 * The test data covers real-world scenarios for setting, overriding, and unsetting the `gradientUnits` attribute,
 ...
 *
 * Key features.
 * - Ensures correct propagation, override, and removal of the `gradientUnits` attribute in SVG element rendering.
 * - Named test data sets for precise failure identification.
 * - Validation of appropriate types and `null` for the `gradientUnits` attribute.
 *
...
{
    /**
     * Provides test cases for SVG `gradientUnits` attribute scenarios.
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `gradientUnits` attribute.
     *
     ...
     *
     * @return array Test data for `gradientUnits` attribute scenarios.
     *
     * @phpstan-return array<string, array{string|null|UnitEnum, mixed[], string|UnitEnum, string, string}>
     */
    public static function values(): array
    {
        $enumCases = EnumDataGenerator::cases(CoordinateUnits::class, 'gradientUnits');
