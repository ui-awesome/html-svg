...
/**
 * Data provider for {@see \UIAwesome\Html\Svg\Tests\Attribute\HasCxTest} class.
 *
 ...
 * - Validation of appropriate types and `null` for the `cx` attribute.
 *
...
final class CxProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `cx` attribute.
     *
     ...
     *
     * @return array Test data for `cx` attribute scenarios.
     *
