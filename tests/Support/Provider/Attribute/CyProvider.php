 ...
 * - Validation of float, int, string, and `null` for the `cy` attribute.
 *
...
final class CyProvider
{
     ...
     *
     * Supplies test data for validating assignment, override, and removal of the SVG `cy` attribute, including float,
     * int, string, and `null`.
     *
