...
/**
 * Unit tests for the {@see HasMarkerHeight} trait managing the `markerHeight` SVG attribute.
 *
 * Verifies rendered output, immutability, and attribute override behavior.
 *
 * Test coverage.
 * - Ensures fluent setters return new instances (immutability).
 * - Ensures no attributes are set when the `markerHeight` attribute is not provided.
 * - Sets the `markerHeight` SVG attribute and renders the expected output.
 *
