...
/**
 * Unit tests for the {@see HasR} trait managing the `r` SVG attribute.
 *
 * Verifies rendered output, immutability, and attribute override behavior.
 *
 * Test coverage.
 * - Ensures fluent setters return new instances (immutability).
 * - Ensures no attributes are set when the `r` attribute is not provided.
 * - Sets the `r` SVG attribute and renders the expected output.
 *
