...
/**
 * Unit tests for {@see Filter} element rendering, content, and attribute handling.
 *
 ...
 * - Renders `<filter>` with inline content.
 * - Renders `<filter>` with representative global HTML and SVG attributes.
